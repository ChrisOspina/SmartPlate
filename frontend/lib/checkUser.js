...
export const checkUser = async () => {
  ...
  if (!STRAPI_API_TOKEN) {
    console.error("No STRAPI_API_TOKEN found in .env.local");
    return null;
  }
  ...
  try {
    ...
    // User does not exist, create new user in Strapi
    ...
    const userData = {
      ...
      password: `clerk_managed_${user.id}_${Date.now()}`, // Dummy password
      confirmed: true,
      blocked: false,
