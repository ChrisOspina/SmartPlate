        ...
        {recipeOfTheDay && (
          <section className="mb-24 relative">
            ...
            <div className="absolute top-20 left-5 z-10 flex items-center gap-3 mb-6">
              <Badge
                variant="outline"
                className="border-2 border-green-600 text-green-700 bg-green-50 font-bold uppercase tracking-wide"
              >
            ...
            >
              <div className="relative bg-white border-2 border-stone-900 overflow-hidden hover:border-green-600 hover:shadow-lg transition-all duration-300 group cursor-pointer">
                <div className="grid md:grid-cols-2 gap-0">
                  ...
                  <div className="p-8 md:p-12 flex flex-col justify-center">
                    <div className="flex flex-wrap gap-2 mb-6">
                      <Badge
                        variant="outline"
                        className="border-2 border-green-600 text-green-700 bg-green-50 font-bold"
                      >
                    ...
                    <h3 className="text-4xl md:text-5xl font-bold text-stone-900 mb-4 group-hover:text-green-600 transition-colors leading-tight">
                      {recipeOfTheDay.strMeal}
                    </h3>
                    ...
                    <Button className="w-fit bg-green-600 hover:bg-green-700 text-white font-bold border-2 border-green-700 px-6 py-5">
