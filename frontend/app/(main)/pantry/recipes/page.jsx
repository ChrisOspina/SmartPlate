        ...
        <div className="mb-8">
          <Link
            ...
            className="inline-flex items-center gap-2 text-stone-600
                hover:text-green-600 transition-colors mb-4 font-medium"
          >
                ...
                {recipesData.recommendationsLimit === "unlimited" ? (
                  <>
                    <span className="text-green-700 font-light">
                      Unlimited AI reccomendations (Pro Plan)
                    </span>
                  </>
                ) : (
                  <span className="text-green-700 font-light">
                    Upgrade to Pro for unlimited AI reccomendations
                  </span>
                )}
              </div>
            </div>
