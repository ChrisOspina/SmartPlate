      ...
      <Link href={data.href}>
        <Card className="rounded-none overflow-hidden border-stone-200 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 cursor-pointer group pt-0">
          ...
          {data.showImage ? (
            ...
            <div className="relative aspect-square bg-linear-to-br from-green-400 via-green-500 to-lime-400 flex items-center justify-center">
            ...
            <div className="flex-1">
              <div className="flex flex-wrap gap-2 mb-3">
                {data.cuisine && (
                  <Badge
                    variant="outline"
                    className="text-green-600 border-green-200 capitalize"
                  >
                    {data.cuisine}
                  </Badge>
                )}
        ...
        <Card className="rounded-none border-stone-200 hover:shadow-lg hover:border-green-200 transition-all cursor-pointer group overflow-hidden py-0">
          <div className="flex flex-col md:flex-row">
            ...
            {data.showImage ? (
              ...
              <div className="relative w-full md:w-48 aspect-video md:aspect-square shrink-0 bg-linear-to-br from-green-400 to-lime-400 flex items-center justify-center">
            ...
            <div className="flex-1 py-5">
              <CardHeader>
                ...
                <CardTitle className="text-xl font-bold text-stone-900 group-hover:text-green-600 transition-colors">
                  {data.title}
                </CardTitle>
